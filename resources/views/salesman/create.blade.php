...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Forms/</span> Salesman
        </h4>
            ...
            <div class="col-xl-6"> <!-- Half-Width Form -->
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Create Salesman</h5>
                        <small class="text-muted float-end">Add new salesman</small>
                    </div>
                        ...
                        <form action="{{ route('salesman.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="salesman-name">Salesman Name</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i class="bx bx-user"></i></span>
                                        <input type="text" id="salesman-name" name="salesman_name" class="form-control"
                                            placeholder="John Doe" value="{{ old('salesman_name') }}" />
                                    </div>
                                </div>
                            ...
                            <!--    <select class="form-select" id="gst-treatment" name="gst_treatment" >-->
